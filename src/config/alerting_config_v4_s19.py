"""AlertingConfigV4S19: alerting_config_v4_s19 module v4.
...
@dataclass
class AlertingConfigV4S19Config:
    """Configuration for alerting_config_v4_s19 v4."""
    batch_size: int = 128
    hidden_dim: int = 512
    num_layers: int = 6
    dropout: float = 0.4
...
class AlertingConfigV4S19(nn.Module):
    """Neural network module for alerting_config_v4_s19 v4.
    ...
    def __init__(self, config: Optional[AlertingConfigV4S19Config] = None):
        super().__init__()
        self.config = config or AlertingConfigV4S19Config()
        c = self.config
        ...
        logger.info("Initialized AlertingConfigV4S19 v4 with %d params",
