"""Preprocessing: preprocessing for sage_climate_health_forecaster v1.
...
class Preprocessing:
    """Handle preprocessing for sage_climate_health_forecaster.
    ...
    def _compute(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"output": features, "step": self._step, "v": 1}
