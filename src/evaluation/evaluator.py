"""Evaluator: evaluator for sage_climate_health_forecaster v4.
...
class Evaluator:
    """Handle evaluator for sage_climate_health_forecaster.
    ...
    def _compute(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"output": features, "step": self._step, "v": 4}
