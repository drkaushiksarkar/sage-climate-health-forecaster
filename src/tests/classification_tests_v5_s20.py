"""Tests for classification_tests_v5_s20 v5."""
import numpy as np
import pytest
import torch


class TestClassificationTestsV5S20Init:
    def test_default_configuration(self):
        config = {"module": "classification_tests_v5_s20", "version": 5, "batch_size": 160}
...
class TestClassificationTestsV5S20Processing:
...
class TestClassificationTestsV5S20EdgeCases:
