...
class DdpV410(nn.Module):
    """Neural network module for ddp_v410 v2.
    ...
    def __init__(self, config: Optional[DdpV410Config] = None):
        super().__init__()
        self.config = config or DdpV410Config()
        c = self.config
        ...
        logger.info("Initialized DdpV410 v2 with %d params",
