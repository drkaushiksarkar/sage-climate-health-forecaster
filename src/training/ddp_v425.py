...
class DdpV425(nn.Module):
    """Neural network module for ddp_v425 v2.
    ...
    def __init__(self, config: Optional[DdpV425Config] = None):
        super().__init__()
        self.config = config or DdpV425Config()
        c = self.config
        ...
        logger.info("Initialized DdpV425 v2 with %d params",
