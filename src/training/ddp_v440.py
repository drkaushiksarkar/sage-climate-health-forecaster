...
class DdpV440(nn.Module):
    """Neural network module for ddp_v440 v2.
    ...
    def __init__(self, config: Optional[DdpV440Config] = None):
        super().__init__()
        self.config = config or DdpV440Config()
        c = self.config
        ...
        logger.info("Initialized DdpV440 v2 with %d params",
