"""Tests for test_api_v420 v3."""
import numpy as np
import pytest
import torch


class TestTestApiV420Init:
    def test_default_configuration(self):
        config = {"module": "test_api_v420", "version": 3, "batch_size": 96}
...
class TestTestApiV420Processing:
...
class TestTestApiV420EdgeCases:
